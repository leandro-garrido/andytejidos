...
if ( ! class_exists( 'Capri_Control_Upsell' ) ) :
	/**
	 * Class Capri_Control_Upsell
	 */
	class Capri_Control_Upsell extends WP_Customize_Control {
		...
		/**
		 * Capri_Control_Upsell constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Capri_Control_Upsell' );
		...
		public function enqueue() {
			wp_enqueue_style( 'capri-upsell-style', get_template_directory_uri() . '/inc/customizer-pro/css/style.css', '1.0.0' );
		}
